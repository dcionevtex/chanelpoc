...
self.onfetch = ev => {
    ...
    if (pathname.endsWith("sw.html")) {
        ev.respondWith(response('<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="robots" content="noindex"><script src="./partytown-sandbox-sw.js?v=0.14.4"><\/script></head></html>'));
    } else {
